...
/// @since 1.0
@Mod(modid = Reference.MOD_ID + "_alfheim", version = Reference.VERSION + "alfheim", updateJSON = "https://forge.curseupdate.com/910715/" + Reference.MOD_ID + "_alfheim", useMetadata = true, dependencies = "required-after:mixinbooter@[10.6,);required-after:redcore@[0.6,);")
